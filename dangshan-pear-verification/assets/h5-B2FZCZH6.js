...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ko(e,t,n){return new na({name:`SphericalGaussianBlur`,defines:{SAMPLES:jo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Yo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qo(){return new na({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Yo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(){return new na({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yo(),fragmentShader:`
...
`},kf=function(){var e=parseInt(document.body.getAttribute(`data-scroll-locked`)||`0`,10);return isFinite(e)?e:0},Af=function(){_.useEffect(function(){return document.body.setAttribute(Df,(kf()+1).toString()),function(){var e=kf()-1;e<=0?document.body.removeAttribute(Df):document.body.setAttribute(Df,e.toString())}},[])},jf=function(e){var t=e.noRelative,n=e.noImportant,r=e.gapMode,i=r===void 0?`margin`:r;Af();var a=_.useMemo(function(){return Tf(i)},[i]);return _.createElement(Ef,{styles:Of(a,!t,i,n?``:`!important`)})},Mf=!1;if(typeof window<`u`)try{var Nf=Object.defineProperty({},"passive",{get:function(){return Mf=!0,!0}});window.addEventListener(`test`,Nf,Nf),window.removeEventListener(`test`,Nf,Nf)}catch{Mf=!1}var Pf=Mf?{passive:!1}:!1,Ff=function(e){return e.tagName===`TEXTAREA`},If=function(e,t){if(!(e instanceof Element))return!1;var n=window.getComputedStyle(e);return n[t]!==`hidden`&&!(n.overflowY===n.overflowX&&!Ff(e)&&n[t]===`visible`)},Lf=function(e){return If(e,`overflowY`)},Rf=function(e){return If(e,`overflowX`)},zf=function(e,t){var n=t.ownerDocument,r=t;do{if(typeof ShadowRoot<`u`&&r instanceof ShadowRoot&&(r=r.host),Hf(e,r)){var i=Uf(e,r);if(i[1]>i[2])return!0}r=r.parentNode}while(r&&r!==n.body);return!1},Bf=function(e){return[e.scrollTop,e.scrollHeight,e.clientHeight]},Vf=function(e){return[e.scrollLeft,e.scrollWidth,e.clientWidth]},Hf=function(e,t){return e===`v`?Lf(t):Rf(t)},Uf=function(e,t){return e===`v`?Bf(t):Vf(t)},Wf=function(e,t){return e===`h`&&t===`rtl`?-1:1},Gf=function(e,t,n,r,i){var a=Wf(e,window.getComputedStyle(t).direction),o=a*r,s=n.target,c=t.contains(s),l=!1,u=o>0,d=0,f=0;do{if(!s)break;var p=Uf(e,s),m=p[0],h=p[1]-p[2]-a*m;(m||h)&&Hf(e,s)&&(d+=h,f+=m);var g=s.parentNode;s=g&&g.nodeType===Node.DOCUMENT_FRAGMENT_NODE?g.host:g}while(!c&&s!==document.body||c&&(t.contains(s)||t===s));return(u&&(i&&Math.abs(d)<1||!i&&o>d)||!u&&(i&&Math.abs(f)<1||!i&&-o>f))&&(l=!0),l},Kf=function(e){return`changedTouches`in e?[e.changedTouches[0].clientX,e.changedTouches[0].clientY]:[0,0]},qf=function(e){return[e.deltaX,e.deltaY]},Jf=function(e){return e&&`current`in e?e.current:e},Yf=function(e,t){return e[0]===t[0]&&e[1]===t[1]},Xf=function(e){return`
  .block-interactivity-${e} {pointer-events: none;}
  .allow-interactivity-${e} {pointer-events: all;}
`},Zf=0,Qf=[];function $f(e){var t=_.useRef([]),n=_.useRef([0,0]),r=_.useRef(),i=_.useState(Zf++)[0],a=_.useState(xf)[0],o=_.useRef(e);_.useEffect(function(){o.current=e},[e]),_.useEffect(function(){if(e.inert){document.body.classList.add(`block-interactivity-${i}`);var t=Yd([e.lockRef.current],(e.shards||[]).map(Jf),!0).filter(Boolean);return t.forEach(function(e){return e.classList.add(`allow-interactivity-${i}`)}),function(){document.body.classList.remove(`block-interactivity-${i}`),t.forEach(function(e){return e.classList.remove(`allow-interactivity-${i}`)})}}},[e.inert,e.lockRef.current,e.shards]);var s=_.useCallback(function(e,t){if(`touches`in e&&e.touches.length===2||e.type===`wheel`&&e.ctrlKey)return!o.current.allowPinchZoom;var i=Kf(e),a=n.current,s=`deltaX`in e?e.deltaX:a[0]-i[0],c=`deltaY`in e?e.deltaY:a[1]-i[1],l,u=e.target,d=Math.abs(s)>Math.abs(c)?`h`:`v`;if(`touches`in e&&d===`h`&&u.type===`range`)return!1;var f=window.getSelection(),p=f&&f.anchorNode;if(p&&(p===u||p.contains(u)))return!1;var m=zf(d,u);if(!m)return!0;if(m?l=d:(l=d===`v`?`h`:`v`,m=zf(d,u)),!m)return!1;if(!r.current&&`changedTouches`in e&&(s||c)&&(r.current=l),!l)return!0;var h=r.current||l;return Gf(h,t,e,h===`h`?s:c,!0)},[]),c=_.useCallback(function(e){var n=e;if(!(!Qf.length||Qf[Qf.length-1]!==a)){var r=`deltaY`in n?qf(n):Kf(n),i=t.current.filter(function(e){return e.name===n.type&&(e.target===n.target||n.target===e.shadowParent)&&Yf(e.delta,r)})[0];if(i&&i.should){n.cancelable&&n.preventDefault();return}if(!i){var c=(o.current.shards||[]).map(Jf).filter(Boolean).filter(function(e){return e.contains(n.target)});(c.length>0?s(n,c[0]):!o.current.noIsolation)&&n.cancelable&&n.preventDefault()}}},[]),l=_.useCallback(function(e,n,r,i){var a={name:e,delta:n,target:r,should:i,shadowParent:ep(r)};t.current.push(a),setTimeout(function(){t.current=t.current.filter(function(e){return e!==a})},1)},[]),u=_.useCallback(function(e){n.current=Kf(e),r.current=void 0},[]),d=_.useCallback(function(t){l(t.type,qf(t),t.target,s(t,e.lockRef.current))},[]),f=_.useCallback(function(t){l(t.type,Kf(t),t.target,s(t,e.lockRef.current))},[]);_.useEffect(function(){return Qf.push(a),e.setCallbacks({onScrollCapture:d,onWheelCapture:d,onTouchMoveCapture:f}),document.addEventListener(`wheel`,c,Pf),document.addEventListener(`touchmove`,c,Pf),document.addEventListener(`touchstart`,u,Pf),function(){Qf=Qf.filter(function(e){return e!==a}),document.removeEventListener(`wheel`,c,Pf),document.removeEventListener(`touchmove`,c,Pf),document.removeEventListener(`touchstart`,u,Pf)}},[]);var p=e.removeScrollBar,m=e.inert;return _.createElement(_.Fragment,null,m?_.createElement(a,{styles:Xf(i)}):null,p?_.createElement(jf,{noRelative:e.noRelative,gapMode:e.gapMode}):null)}function ep(e){for(var t=null;e!==null;)e instanceof ShadowRoot&&(t=e.host,e=e.host),e=e.parentNode;return t}var tp=uf(df,$f),np=_.forwardRef(function(e,t){return _.createElement(pf,qd({},e,{ref:t,sideCar:tp}))});np.classNames=pf.classNames;var rp=function(e){return typeof document>`u`?null:(Array.isArray(e)?e[0]:e).ownerDocument.body},ip=new WeakMap,ap=new WeakMap,op={},sp=0,cp=function(e){return e&&(e.host||cp(e.parentNode))},lp=function(e,t){return t.map(function(t){if(e.contains(t))return t;var n=cp(t);return n&&e.contains(n)?n:(console.error(`aria-hidden`,t,`in not contained inside`,e,`. Doing nothing`),null)}).filter(function(e){return!!e})},up=function(e,t,n,r){var i=lp(t,Array.isArray(e)?e:[e]);op[n]||(op[n]=new WeakMap);var a=op[n],o=[],s=new Set,c=new Set(i),l=function(e){!e||s.has(e)||(s.add(e),l(e.parentNode))};i.forEach(l);var u=function(e){!e||c.has(e)||Array.prototype.forEach.call(e.children,function(e){if(s.has(e))u(e);else try{var t=e.getAttribute(r),i=t!==null&&t!==`false`,c=(ip.get(e)||0)+1,l=(a.get(e)||0)+1;ip.set(e,c),a.set(e,l),o.push(e),c===1&&i&&ap.set(e,!0),l===1&&e.setAttribute(n,`true`),i||e.setAttribute(r,`true`)}catch(t){console.error(`aria-hidden: cannot operate on `,e,t)}})};return u(t),s.clear(),sp++,function(){o.forEach(function(e){var t=ip.get(e)-1,i=a.get(e)-1;ip.set(e,t),a.set(e,i),t||(ap.has(e)||e.removeAttribute(r),ap.delete(e)),i||e.removeAttribute(n)}),sp--,sp||(ip=new WeakMap,ip=new WeakMap,ap=new WeakMap,op={})}},dp=function(e,t,n){n===void 0&&(n=`data-aria-hidden`);var r=Array.from(Array.isArray(e)?e:[e]),i=t||rp(e);return i?(r.push.apply(r,Array.from(i.querySelectorAll(`[aria-live], script`))),up(r,i,n,`aria-hidden`)):function(){return null}},fp=`Dialog`,[pp,mp]=ju(fp),[hp,gp]=pp(fp),_p=e=>{let{__scopeDialog:t,children:n,open:r,defaultOpen:i,onOpenChange:a,modal:o=!0}=e,s=_.useRef(null),c=_.useRef(null),[l,u]=Ru({prop:r,defaultProp:i??!1,onChange:a,caller:fp});return(0,$.jsx)(hp,{scope:t,triggerRef:s,contentRef:c,contentId:Iu(),titleId:Iu(),descriptionId:Iu(),open:l,onOpenChange:u,onOpenToggle:_.useCallback(()=>u(e=>!e),[u]),modal:o,children:n})};_p.displayName=fp;var vp=`DialogTrigger`,yp=_.forwardRef((e,t)=>{let{__scopeDialog:n,...r}=e,i=gp(vp,n),a=ku(t,i.triggerRef);return(0,$.jsx)(ed.button,{type:`button`,"aria-haspopup":`dialog`,"aria-expanded":i.open,"aria-controls":i.open?i.contentId:void 0,"data-state":zp(i.open),...r,ref:a,onClick:Eu(e.onClick,i.onOpenToggle)})});yp.displayName=vp;var bp=`DialogPortal`,[xp,Sp]=pp(bp,{forceMount:void 0}),Cp=e=>{let{__scopeDialog:t,forceMount:n,children:r,container:i}=e,a=gp(bp,t);return(0,$.jsx)(xp,{scope:t,forceMount:n,children:_.Children.map(r,e=>(0,$.jsx)(Ld,{present:n||a.open,children:(0,$.jsx)(Fd,{asChild:!0,container:i,children:e})}))})};Cp.displayName=bp;var wp=`DialogOverlay`,Tp=_.forwardRef((e,t)=>{let n=Sp(wp,e.__scopeDialog),{forceMount:r=n.forceMount,...i}=e,a=gp(wp,e.__scopeDialog);return a.modal?(0,$.jsx)(Ld,{present:r||a.open,children:(0,$.jsx)(Dp,{...i,ref:t})}):null});Tp.displayName=wp;var Ep=Hu(`DialogOverlay.RemoveScroll`),Dp=_.forwardRef((e,t)=>{let{__scopeDialog:n,...r}=e,i=gp(wp,n),a=ku(t,fd());return(0,$.jsx)(np,{as:Ep,allowPinchZoom:!0,shards:[i.contentRef],children:(0,$.jsx)(ed.div,{"data-state":zp(i.open),...r,ref:a,style:{pointerEvents:`auto`,...r.style}})})}),Op=`DialogContent`,kp=_.forwardRef((e,t)=>{let n=Sp(Op,e.__scopeDialog),{forceMount:r=n.forceMount,...i}=e,a=gp(Op,e.__scopeDialog);return(0,$.jsx)(Ld,{present:r||a.open,children:a.modal?(0,$.jsx)(Ap,{...i,ref:t}):(0,$.jsx)(jp,{...i,ref:t})})});kp.displayName=Op;var Ap=_.forwardRef((e,t)=>{let n=gp(Op,e.__scopeDialog),r=_.useRef(null),i=ku(t,n.contentRef,r);return _.useEffect(()=>{let e=r.current;if(e)return dp(e)},[]),(0,$.jsx)(Mp,{...e,ref:i,trapFocus:n.open,disableOutsidePointerEvents:n.open,onCloseAutoFocus:Eu(e.onCloseAutoFocus,e=>{e.preventDefault(),n.triggerRef.current?.focus()}),onPointerDownOutside:Eu(e.onPointerDownOutside,e=>{let t=e.detail.originalEvent,n=t.button===0&&t.ctrlKey===!0;(t.button===2||n)&&e.preventDefault()}),onFocusOutside:Eu(e.onFocusOutside,e=>e.preventDefault())})}),jp=_.forwardRef((e,t)=>{let n=gp(Op,e.__scopeDialog),r=_.useRef(!1),i=_.useRef(!1);return(0,$.jsx)(Mp,{...e,ref:t,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:t=>{e.onCloseAutoFocus?.(t),t.defaultPrevented||(r.current||n.triggerRef.current?.focus(),t.preventDefault()),r.current=!1,i.current=!1},onInteractOutside:t=>{e.onInteractOutside?.(t),t.defaultPrevented||(r.current=!0,t.detail.originalEvent.type===`pointerdown`&&(i.current=!0));let a=t.target;n.triggerRef.current?.contains(a)&&t.preventDefault(),t.detail.originalEvent.type===`focusin`&&i.current&&t.preventDefault()}})}),Mp=_.forwardRef((e,t)=>{let{__scopeDialog:n,trapFocus:r,onOpenAutoFocus:i,onCloseAutoFocus:a,...o}=e,s=gp(Op,n);return Gd(),(0,$.jsx)($.Fragment,{children:(0,$.jsx)(Sd,{asChild:!0,loop:!0,trapped:r,onMountAutoFocus:i,onUnmountAutoFocus:a,children:(0,$.jsx)(ld,{role:`dialog`,id:s.contentId,"aria-describedby":s.descriptionId,"aria-labelledby":s.titleId,"data-state":zp(s.open),...o,ref:t,deferPointerDownOutside:!0,onDismiss:()=>s.onOpenChange(!1)})})})}),Np=`DialogTitle`,Pp=_.forwardRef((e,t)=>{let{__scopeDialog:n,...r}=e,i=gp(Np,n);return(0,$.jsx)(ed.h2,{id:i.titleId,...r,ref:t})});Pp.displayName=Np;var Fp=`DialogDescription`,Ip=_.forwardRef((e,t)=>{let{__scopeDialog:n,...r}=e,i=gp(Fp,n);return(0,$.jsx)(ed.p,{id:i.descriptionId,...r,ref:t})});Ip.displayName=Fp;var Lp=`DialogClose`,Rp=_.forwardRef((e,t)=>{let{__scopeDialog:n,...r}=e,i=gp(Lp,n);return(0,$.jsx)(ed.button,{type:`button`,...r,ref:t,onClick:Eu(e.onClick,()=>i.onOpenChange(!1))})});Rp.displayName=Lp;function zp(e){return e?`open`:`closed`}function Bp({children:e,className:t=``}){return(0,$.jsx)(`div`,{className:`mobile-page `+t,children:e})}function Vp({open:e,onOpenChange:t,title:n,description:r,snap:i=.62,children:a}){return(0,$.jsx)(_p,{open:e,onOpenChange:t,children:(0,$.jsxs)(Cp,{children:[(0,$.jsx)(Tp,{className:`h5-sheet-overlay`}),(0,$.jsxs)(kp,{className:`h5-sheet`,style:{maxHeight:`${Math.round(i*100)}dvh`},children:[(0,$.jsxs)(`div`,{className:`h5-sheet-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(Pp,{children:n}),r&&(0,$.jsx)(Ip,{children:r})]}),(0,$.jsx)(Rp,{"aria-label":`关闭`,children:(0,$.jsx)(Tu,{size:20})})]}),(0,$.jsx)(`div`,{className:`h5-sheet-content`,children:a})]})]})})}function Hp(e){return new URL(`assets/brand/`+e,document.baseURI).href}var Up=[`first`,`repeat`,`invalid`,`error`,`loading`],Wp={first:`首次查询`,repeat:`再次查询`,invalid:`未查到编码`,error:`连接失败`,loading:`正在查询`},Gp={first:{title:`编码核验通过`,description:`该编码已在查询系统登记`,note:`本次为首次查询`},repeat:{title:`此编码已被查询`,description:`该编码已登记，请核对首次查询时间`,note:`重复查询不代表产品为假`},invalid:{title:`暂未查到此编码`,description:`请核对标签，或联系购买商家协助确认`,note:`请保留梨果标签及购买凭证`},error:{title:`暂时无法完成查询`,description:`网络连接异常，请稍后重试`,note:`连接失败不代表编码无效`},loading:{title:`正在核验编码`,description:`正在读取这枚标签的查询记录`,note:`请稍候，结果将在此显示`}};function Kp({paused:e,onReady:t,onFail:n,onSettled:r}){let i=(0,_.useRef)(null),a=(0,_.useRef)(e);return(0,_.useEffect)(()=>{a.current=e},[e]),(0,_.useEffect)(()=>{let e=i.current,o=!1,s=!0,c=0,l;try{l=new Pl({alpha:!0,antialias:!0,powerPreference:`low-power`,preserveDrawingBuffer:!0})}catch{n();return}l.setPixelRatio(Math.min(window.devicePixelRatio,2)),l.outputColorSpace=$e,l.toneMapping=4,l.toneMappingExposure=.94,l.shadowMap.enabled=!0,l.shadowMap.type=3,e.appendChild(l.domElement),l.domElement.setAttribute(`aria-hidden`,`true`);let u=new jn,d=new Ja(31,1,.1,30);d.zoom=1.17,d.position.set(0,2.6,4.3),d.lookAt(0,.05,0);let f=new Fl,p=new Vo(l),m=p.fromScene(f,.06);u.environment=m.texture,u.add(new Ia(16777215,11314317,.2));let h=new $a(16774362,2.5);h.position.set(-4.5,6.5,3),h.castShadow=!0,h.shadow.mapSize.set(1024,1024),h.shadow.camera.left=-3,h.shadow.camera.right=3,h.shadow.camera.top=3,h.shadow.camera.bottom=-3,h.shadow.normalBias=.03,h.shadow.radius=7,h.shadow.blurSamples=12,u.add(h);let g=new $a(15857151,.2);g.position.set(3,1,4),u.add(g);let _=new $a(16777215,.6);_.position.set(1,3,-3),u.add(_);let v=new Cn;v.rotation.y=-.45,v.rotation.z=-.055,u.add(v);let b=new Gi(1,112,80),x=b.attributes.position,S=b.attributes.uv,C=[];for(let e=0;e<x.count;e++){let t=Math.PI*(1-S.getY(e)),n=S.getX(e)*Math.PI*2,r=Math.sin(t),i=Math.cos(t),a=r**.94*(1-.025*i)*(1+.013*Math.cos(n*5+.2)*r+.009*Math.cos(n*3)),o=.94*i-.14*Math.exp(-((t/.24)**2))+.085*Math.exp(-(((Math.PI-t)/.28)**2));x.setXYZ(e,-a*Math.cos(n),o+.012*Math.cos(n*3)*r,a*Math.sin(n));let s=Math.exp(-((t/.21)**2)),c=new J().setRGB(1-s*.6,1-s*.66,1-s*.76);C.push(c.r,c.g,c.b)}b.setAttribute(`color`,new pr(C,3)),b.computeVertexNormals();let w=new aa({color:16113309,roughness:.47,metalness:0,clearcoat:.1,clearcoatRoughness:.6,envMapIntensity:.06,vertexColors:!0}),T=new Yr(b,w);T.castShadow=!0,T.receiveShadow=!0,v.add(T);let E=new Ei([new K(0,.735,0),new K(.014,.83,.008),new K(.043,.96,.005),new K(.075,1.095,-.015)]),D=new Ki(E,18,.032,10,!1),O=new ia({color:6832678,roughness:.95}),k=new Yr(D,O);k.castShadow=!0,v.add(k);let A=new Gi(.033,10,6),ee=new ia({color:10584149,roughness:1}),j=new Yr(A,ee);j.scale.y=.25,j.position.copy(E.getPoint(1)),v.add(j);let te=new Wi(12,12),ne=new qi({opacity:.085}),re=new Yr(te,ne);re.rotation.x=-Math.PI/2,re.position.y=-.885,re.receiveShadow=!0,u.add(re);let M;new Pa().load(Hp(`pear-skin.jpg`),n=>{if(o){n.dispose();return}M=n,n.colorSpace=$e,n.wrapS=y,n.wrapT=y,n.repeat.set(2,1),n.anisotropy=Math.min(l.capabilities.getMaxAnisotropy(),4),w.map=n,w.bumpMap=n,w.bumpScale=.017,w.needsUpdate=!0,N(),e.dataset.ready=`true`,t()},void 0,()=>{o||n()});let N=()=>l.render(u,d),ie=()=>{let t=e.clientWidth,n=e.clientHeight;l.setSize(t,n),d.aspect=t/n,d.updateProjectionMatrix(),N()},ae=new ResizeObserver(ie);ae.observe(e),ie();let oe=new IntersectionObserver(([e])=>{s=e.isIntersecting},{threshold:.05});oe.observe(e);let P=0,se=!1,F=0,I=v.rotation.y,ce=0,L=null,le=()=>{a.current=!0,se=!1,r()},ue=e=>{!M||e.pointerType===`mouse`&&e.button!==0||(L={id:e.pointerId,x:e.clientX,y:e.clientY,lastX:e.clientX,time:performance.now(),angle:v.rotation.y,axis:`pending`})},de=t=>{if(!L||t.pointerId!==L.id)return;let n=t.clientX-L.x,r=t.clientY-L.y;if(L.axis===`pending`){if(Math.max(Math.abs(n),Math.abs(r))<7)return;L.axis=Math.abs(n)>Math.abs(r)?`x`:`y`,L.axis===`x`&&(le(),ce=0,e.setPointerCapture(t.pointerId),e.dataset.dragging=`true`)}if(L.axis!==`x`)return;t.stopPropagation(),t.preventDefault();let i=performance.now(),a=2*Math.PI/e.getBoundingClientRect().width;ce=Math.max(-6,Math.min(6,(t.clientX-L.lastX)*a/Math.max(.016,(i-L.time)/1e3))),v.rotation.y=L.angle+n*a,L.lastX=t.clientX,L.time=i,N(),e.dataset.angle=v.rotation.y.toFixed(3)},fe=t=>{!L||t.pointerId!==L.id||(L.axis===`x`&&((performance.now()-L.time>100||t.type===`pointercancel`)&&(ce=0),e.hasPointerCapture(t.pointerId)&&e.releasePointerCapture(t.pointerId)),L=null,e.dataset.dragging=`false`)},pe=t=>{t.key!==`ArrowLeft`&&t.key!==`ArrowRight`||(t.preventDefault(),le(),ce=0,v.rotation.y+=(t.key===`ArrowLeft`?-1:1)*Math.PI/12,N(),e.dataset.angle=v.rotation.y.toFixed(3))};e.addEventListener(`pointerdown`,ue),e.addEventListener(`pointermove`,de),e.addEventListener(`pointerup`,fe),e.addEventListener(`pointercancel`,fe),e.addEventListener(`keydown`,pe);let me=t=>{c=requestAnimationFrame(me);let n=Math.min((t-P)/1e3,.05);if(P=t,!(!s||document.hidden||!M)){if(a.current)se=!1,L?.axis!==`x`&&Math.abs(ce)>.002&&(v.rotation.y+=ce*n,ce*=Math.exp(-7*n),N());else{se||(se=!0,F=0,I=v.rotation.y,ce=0),F+=n;let e=Math.min(F/6.2,1);v.rotation.y=I+2*Math.PI*(.5-.5*Math.cos(Math.PI*e)),e===1&&le(),N()}e.dataset.angle=v.rotation.y.toFixed(3),e.dataset.motion=a.current?L?.axis===`x`?`drag`:Math.abs(ce)>.002?`settling`:`idle`:`intro`}};return c=requestAnimationFrame(me),l.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),n()}),()=>{o=!0,cancelAnimationFrame(c),e.removeEventListener(`pointerdown`,ue),e.removeEventListener(`pointermove`,de),e.removeEventListener(`pointerup`,fe),e.removeEventListener(`pointercancel`,fe),e.removeEventListener(`keydown`,pe),oe.disconnect(),ae.disconnect(),M?.dispose(),[b,D,A,te].forEach(e=>e.dispose()),[w,O,ee,ne].forEach(e=>e.dispose()),m.dispose(),f.dispose(),p.dispose(),l.dispose(),l.domElement.remove()}},[]),(0,$.jsx)(`div`,{className:`pear-canvas`,ref:i,role:`img`,tabIndex:0,"aria-label":`三维砀山酥梨，左右拖动旋转，也可使用左右方向键`})}function qp({verification:e,onRetry:t}={}){let n=new URLSearchParams(window.location.search).get(`state`),[r,i]=(0,_.useState)(e?.state??(Up.includes(n)?n:`first`)),[a,o]=(0,_.useState)(()=>window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(``);(0,_.useEffect)(()=>{e&&i(e.state)},[e]);let[p,m]=(0,_.useState)(!1),[h,g]=(0,_.useState)(!1),[v,y]=(0,_.useState)(!1),b=(0,_.useRef)(void 0);(0,_.useEffect)(()=>()=>clearTimeout(b.current),[]),(0,_.useEffect)(()=>{document.title=`砀山酥梨 · 防伪查询`,document.documentElement.lang=`zh-CN`},[]);let x=e=>{clearTimeout(b.current),i(e),g(!1)},S=()=>{if(e&&t){t();return}i(`loading`),b.current=setTimeout(()=>i(`first`),1100)},C=async()=>{try{await navigator.clipboard.writeText(e?.code??`DEMO 0000 0183`),y(!0)}catch{y(!1)}},w=Gp[r],T=r===`first`||r===`repeat`,E=e?.code??`DEMO 0000 0183`,D=r===`first`?_u:r===`error`?Cu:xu;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(Bp,{className:`app-screen verification-screen`,children:(0,$.jsxs)(`main`,{className:`verify-page`,children:[(0,$.jsxs)(`section`,{className:`brand-hero`,"aria-label":`砀山酥梨`,children:[(0,$.jsx)(`img`,{className:`contours`,src:Hp(`contours.svg`),alt:``}),(0,$.jsxs)(`header`,{className:`brand-header`,children:[(0,$.jsx)(`img`,{className:`brand-seal`,src:Hp(`seal.svg`),alt:`砀山有礼`}),(0,$.jsx)(`img`,{className:`brand-logo`,src:Hp(`logo.png`),alt:`砀山`})]}),(0,$.jsxs)(`div`,{className:`hero-heading`,children:[(0,$.jsx)(`h1`,{children:`砀山酥梨 · 防伪查询`}),(0,$.jsx)(`p`,{lang:`en`,children:`PRODUCT VERIFICATION`})]}),(0,$.jsxs)(`div`,{className:`pear-stage`,children:[!l&&(0,$.jsx)(Kp,{paused:a,onReady:()=>c(!0),onFail:()=>u(!0),onSettled:()=>o(!0)}),l&&(0,$.jsx)(`img`,{className:`pear-poster`,src:Hp(`pear-static.png`),alt:`砀山酥梨展示`}),!s&&!l&&(0,$.jsx)(`span`,{className:`model-loading`,children:`加载酥梨展示…`})]}),(0,$.jsxs)(`div`,{className:`pear-features `+(s?`visible`:``),"aria-label":`酥梨特点`,children:[(0,$.jsxs)(`span`,{className:`feature feature-origin`,children:[(0,$.jsx)(du,{size:13,weight:`regular`}),`安徽砀山`]}),(0,$.jsxs)(`span`,{className:`feature feature-crisp`,children:[(0,$.jsx)(yu,{size:13,weight:`regular`}),`酥脆甘甜`]}),(0,$.jsxs)(`span`,{className:`feature feature-juice`,children:[(0,$.jsx)(lu,{size:13,weight:`regular`}),`皮薄多汁`]}),(0,$.jsxs)(`span`,{className:`feature feature-full`,children:[(0,$.jsx)(au,{size:13,weight:`regular`}),`果大核小`]})]}),(0,$.jsx)(`p`,{className:`gesture-hint`,children:`左右拖动 · 360° 查看`}),(0,$.jsx)(`button`,{className:`motion-control`,"aria-label":a?`重新播放入场旋转`:`暂停自动旋转`,"aria-pressed":a,onClick:()=>o(!a),disabled:l||!s,children:a?(0,$.jsx)(hu,{size:17,weight:`fill`}):(0,$.jsx)(pu,{size:17,weight:`fill`})})]}),(0,$.jsxs)(`section`,{className:`verification-result`,"aria-labelledby":`result-title`,"aria-live":`polite`,"aria-busy":r===`loading`,children:[(0,$.jsx)(`p`,{className:`eyebrow`,children:`查询结果`}),(0,$.jsx)(`h2`,{id:`result-title`,children:w.title}),(0,$.jsx)(`p`,{className:`result-description`,children:w.description}),(0,$.jsxs)(`div`,{className:`query-note `+(r===`repeat`||r===`invalid`?`caution`:``),children:[r===`loading`?(0,$.jsx)($l,{className:`query-spinner`,size:28}):(0,$.jsx)(D,{size:28,weight:`regular`}),(0,$.jsx)(`span`,{children:w.note})]}),T?(0,$.jsxs)(`dl`,{className:`result-details`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`对应产品`}),(0,$.jsx)(`dd`,{children:e?.productName??`砀山酥梨`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`查询次数`}),(0,$.jsxs)(`dd`,{children:[e?.queryCount??(r===`repeat`?3:1),` 次`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`首次查询`}),(0,$.jsx)(`dd`,{className:`numeric`,children:e?.firstQueriedAt??`2026.09.17 14:30`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`查询编码`}),(0,$.jsx)(`dd`,{className:`numeric`,children:E})]})]}):(0,$.jsxs)(`div`,{className:`unresolved-state`,children:[(0,$.jsx)(`p`,{children:r===`loading`?`正在获取查询记录…`:r===`error`?`请确认网络已连接，再重新获取查询结果。`:`请重新扫描梨果上的二维码，确认标签完整、清晰。`}),(0,$.jsxs)(`div`,{className:`unresolved-code`,children:[`查询编码 `,(0,$.jsx)(`span`,{children:E})]})]}),r===`error`&&(0,$.jsxs)(`button`,{className:`primary-action`,onClick:S,children:[(0,$.jsx)($l,{size:18}),`重新查询`]}),(0,$.jsxs)(`button`,{className:`help-action`,onClick:()=>{m(!0),y(!1)},children:[`对查询结果有疑问？`,(0,$.jsx)(tu,{size:21})]}),(0,$.jsxs)(`footer`,{className:`demo-footer`,children:[(0,$.jsx)(`span`,{children:e?`查询记录由防伪服务提供`:`演示页面 · 数据仅作界面展示`}),!e&&(0,$.jsx)(`button`,{onClick:()=>g(!0),"aria-label":`切换演示查询状态`,children:`切换状态`})]}),new URLSearchParams(window.location.search).get(`export`)===`1`&&(0,$.jsxs)(`div`,{className:`export-tools`,children:[(0,$.jsx)(`button`,{onClick:()=>{let e=document.querySelector(`.pear-canvas canvas`);e&&f(e.toDataURL(`image/png`))},children:`准备平面源文件素材`}),d&&(0,$.jsx)(`a`,{href:d,download:`pear-render.png`,children:`下载酥梨渲染图`})]})]})]})}),(0,$.jsx)(Vp,{open:p,onOpenChange:m,title:`查询帮助`,description:`核对标签与查询记录`,snap:.62,children:(0,$.jsxs)(`div`,{className:`help-content`,children:[(0,$.jsx)(`p`,{className:`help-intro`,children:`每一枚标签，都有自己的查询记录。`}),(0,$.jsx)(`h3`,{children:`第一次扫码，却提示已被查询？`}),(0,$.jsx)(`p`,{children:`先核对首次查询时间。您或他人再次扫码都会产生查询记录，重复查询本身不能作为真假判断依据。`}),(0,$.jsx)(`h3`,{children:`编码未查到或记录存疑`}),(0,$.jsx)(`p`,{children:`请保留梨果标签和购买凭证，联系购买商家协助核实编码。`}),(0,$.jsxs)(`button`,{className:`copy-code`,onClick:C,children:[v?(0,$.jsx)(ru,{size:18}):(0,$.jsx)(su,{size:18}),(0,$.jsx)(`span`,{children:v?`查询编码已复制`:`复制查询编码`}),(0,$.jsx)(`small`,{children:E})]}),(0,$.jsx)(`button`,{className:`primary-action`,onClick:()=>m(!1),children:`我知道了`})]})}),(0,$.jsx)(Vp,{open:h,onOpenChange:g,title:`查询状态预览`,description:`仅用于设计演示，不执行真实防伪查询`,snap:.51,children:(0,$.jsxs)(`div`,{className:`state-options`,children:[Up.map(e=>(0,$.jsxs)(`button`,{onClick:()=>x(e),children:[Wp[e],r===e?(0,$.jsx)(ru,{size:20}):(0,$.jsx)(tu,{size:18})]},e)),(0,$.jsxs)(`button`,{className:`close-demo`,onClick:()=>g(!1),children:[(0,$.jsx)(Tu,{size:17}),`关闭`]})]})})]})}var Jp=new URLSearchParams(location.search),Yp=Jp.has(`code`),Xp=Jp.get(`code`)?.trim().slice(0,128),Zp={live:!0,state:`loading`,code:Xp??``},Qp={live:!0,state:`error`,code:Xp??``};function $p(){let[e,t]=(0,_.useState)(Yp?Xp?Zp:Qp:void 0),[n,r]=(0,_.useState)(0);return(0,_.useEffect)(()=>{if(Yp){if(!Xp){t(Qp);return}t(Qp)}},[n,(0,_.useMemo)(()=>crypto.randomUUID(),[n])]),(0,$.jsx)(qp,{verification:e,onRetry:()=>{t(Zp),r(e=>e+1)}})}(0,v.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(_.StrictMode,{children:(0,$.jsx)($p,{})}));